...
(function () {
  ...
  var toggleAccordion = function toggleAccordion(evt) {
    Array.prototype.forEach.call(accordionPanes, function (accordionPane) {
      var button = accordionPane.closest('.accordion').querySelector('.accordion__header');

      if (button === evt.target && !button.classList.contains('accordion__header--inactive') || button !== evt.target) {
  ...
  Array.prototype.forEach.call(accordionItems, function (accordion) {
    var accordionToggleButton = accordion.querySelector('.accordion__header');
...
(function () {
  ...
  if (popup) {
    ...
    var modalFocusTrap = focus_trap__WEBPACK_IMPORTED_MODULE_1__["createFocusTrap"]('.modal');

    var existVerticalScroll = function existVerticalScroll() {
...
var btnShow = document.querySelector('.about-us__button');
var hiddenText = document.querySelector('.about-us__text--hidden');
...
var elements = document.querySelectorAll('.imaskjs');

for (var i = 0; i < elements.length; i++) {
  new imask__WEBPACK_IMPORTED_MODULE_0__["default"](elements[i], {
